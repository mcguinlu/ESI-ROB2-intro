...
Modepst __agreement rates__ between assessors
...
__Example:__ Q1.1 - Was the allocation sequence random?
...
__Response:__ .g[__Yes__]

--

__Justification:__ “Randomization was centralized and stratified according to medicine status” 
...
__Justification:__ "DEMO trial staff contacted the Copenhagen Trial Unit (CTU) by phone. Randomization was carried out by the CTU using computerized restricted randomization with a block size of 6. The block size and thus the allocation sequence were unknown to the DEMO trial staff.”
...
__Response:__ .g[__Probably No__]

--

__Justification:__ “At entry, the 3 groups looked balanced, although the HAM-D17 score was lower in the relaxation group, which also had a higher proportion of male participants.”
...
# Domain 1: Bias due to deviations from intended interventions
...
Effects will differ if patients __do not receive__ assigned intervention or __deviate from__ assigned intervention after baseline
...
## Challenges of identifing protocol-consitent deviations

---

Deviations from intended interventions are not important when interest is in the effect of assignment to intervention 
...
. . . provided these deviations did not arise because of the trial context
...
However, deviations from intended intervention may lead to bias in the effect of adhering to intervention.
...
Add extra two slides on blinding here

---

## Element 3: Appropriate analysis
...
__Response:__ .r[__Yes__] 

--

__Justification:__ Interventions could not be blinded to participants or therapists, as they were aerobic exercise and relaxation.
...
__Justification:__ High proportion of relaxation group did not attend (11/55) while only one aerobic did not attend but __*I*__ think 

VO2 max much higher in aerobic group

???

__Have ou can legitimately disagree with me!__
...
## Q 2.4 & 2.5 <br> Don't need to answer, as answered .g[__PN__] to Q 2.3
...
__Response:__ .g[__Y__]

--

__Justification:__ Analysis was done “on the basis of the intention-to-treat principle, and all patients included were analyzed according to their original group assignment.”
...
## Q 2.7 <br> 
Don't need to answer, as answered .g[__Y__] to Q 2.6
